  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const scrollProgress = Math.max(
        0,
        Math.min(1, currentScrollY / docHeight)
      );
      ...
      if (titleDivRef.current) {
        ...
        if (scrollDirection === "down") {
          titleDivRef.current.style.transform = `translateY(${
            scrollOffset * titleParallaxFactor
          }px)`;
        } else {
          titleDivRef.current.style.transform = `translateY(${
            scrollOffset * titleParallaxFactor * 0.5
          }px)`;
        }
      ...
      if (descriptionDivRef.current) {
        ...
        descriptionDivRef.current.style.transform = `translateY(${
          scrollOffset * descParallaxFactor
        }px)`;
    ...
    <div className="font-sans bg-stone-100">
      ...
      <nav
        className={`fixed w-full transition-all duration-500 z-50 ${
          isScrolled
            ? "bg-stone-900 bg-opacity-90 shadow-lg backdrop-blur-md py-2 md:py-3"
      ...
      >
        <div className="container mx-auto px-3 md:px-4">
          <div className="flex justify-between items-center">
            <div
              className={`text-stone-700 font-bold text-base md:text-lg lg:text-2xl transition-all duration-500 ${
            ...
            <ul className="hidden lg:flex space-x-4 xl:space-x-8 text-sm xl:text-lg font-medium">
              {[
                ...
                { id: "forum", label: "Forum", isRoute: true },
              ].map(({ id, label, isRoute }) => (
                <li key={id}>
                  <a
                    href={
                      isRoute ? (id === "chat" ? "/chat" : "/forum") : `#${id}`
                    }
                    onClick={(e) => {
                      if (!isRoute) {
                        e.preventDefault();
            ...
            <div className="lg:hidden mt-3 pb-3 border-t border-stone-700">
              <ul className="space-y-2 pt-3">
                {[
                  ...
                  .filter((item) => !item.showOnlyIfLoggedIn || user)
                  .map(({ id, label, isRoute }) => (
                    <li key={id}>
                      <a
                        href={isRoute ? `/${id}` : `#${id}`}
                        ...
                        className={`block py-2 px-3 text-sm font-medium rounded-md transition-all duration-300 ${
                          currentSection === id
                            ? "text-amber-500 bg-amber-900 bg-opacity-20"
          ...
          <div className="py-6 sm:py-8 md:py-12 lg:py-20">
            ...
            >
              <h1 className="text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif mb-3 sm:mb-4 md:mb-6 leading-tight">
                Your <span className="text-amber-500">AI-Powered</span> Private
                Chef
              </h1>
              <div
              ...
              >
                <p className="text-amber-100 leading-5 sm:leading-6 md:leading-8 text-sm sm:text-base md:text-lg max-w-3xl mx-auto">
                  Savr plans your meals like a private chef would: listening to
                  what you need, working with what you have, and personalizing
            ...
            <div className="glass-morph rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-6 lg:p-8 mb-4 sm:mb-6 md:mb-8 shadow-xl transition-all duration-700">
              <div className="text-center mb-3 sm:mb-4 md:mb-6">
                ...
                <h3 className="text-base sm:text-lg md:text-xl font-serif text-amber-300 mb-1 md:mb-2">
                  Try Savr Assistant
                </h3>
                <p className="text-amber-100 text-xs sm:text-sm md:text-base px-2">
                  Ask me anything about what to eat, how to cook, or how to
                  nourish your body.
                </p>
              </div>
              ...
              <div className="max-w-xl mx-auto">
                ...
                {!user && (
                  <div className="text-center mt-2 md:mt-3 px-2">
                    <p className="text-amber-200 text-xs sm:text-sm mb-1 md:mb-2">
                ...
                {[
                  {
                    ...
                    desc: "Tell Savr what you're craving or need, and it creates personalized meal plans that fit your preferences, dietary needs, and what's already in your kitchen.",
                  },
                  {
                    icon: Heart,
                    title: "Health Companion",
                    desc: "Whether you're dealing with hair loss, eye strain, fatigue, or brain fog, Savr creates personalized meal plans to support your specific needs.",
                  },
                  {
                    icon: Apple,
                    title: "Ingredient Intelligence",
                    desc: "Learn how each ingredient fuels your body and supports your well-being, from how miso boosts gut health to why sesame seeds support hormone balance.",
                  },
                ].map((feature, index) => (
                  <div
                    key={index}
                    className="flex items-start mb-4 sm:mb-6 md:mb-8 opacity-0 animate-on-scroll"
                  ...
                  >
                    ...
                    <div className="ml-3 sm:ml-4 md:ml-6">
                      <h3 className="text-base sm:text-lg md:text-xl mb-1 sm:mb-2 md:mb-3 text-amber-800 font-medium">
                        {feature.title}
                      </h3>
                ...
                {[
                  {
                    ...
                    desc: "With every plan, track your environmental impact by reducing food waste, supporting local ingredients and fostering more sustainable eating habits.",
                  },
                  {
                    icon: Clock,
                    title: "Rescue Near-Expiry Items",
                    desc: "Savr connects you to perfectly edible, near-expiry items, making it quick and easy to rescue them and turn them into delicious meals at home.",
                  },
                  {
                    icon: Users,
                    title: "Community Impact",
                    desc: "Connect to food rescue hubs, community kitchens, and non-profits to tackle food insecurity and build a sustainable food system.",
                  },
                ].map((feature, index) => (
                  <div
                    key={index}
          ...
          <div className="container mx-auto px-3 sm:px-4 py-8 sm:py-12 md:py-16 lg:py-24">
            <div className="ml-auto mr-auto max-w-2xl">
              <div className="bg-white bg-opacity-95 p-4 sm:p-6 md:p-8 lg:p-12 rounded-xl sm:rounded-2xl mb-6 sm:mb-8 md:mb-12 shadow-xl animate-on-scroll scale-up">
                <h2 className="mb-4 sm:mb-6 md:mb-8 text-amber-800 text-xl sm:text-2xl md:text-3xl lg:text-4xl font-serif">
                  How Savr Works
                </h2>
                <div className="space-y-4 sm:space-y-6 md:space-y-8 lg:space-y-12">
                  {[
                    {
                      num: 1,
                      title: "Tell Savr What You Want",
                      desc: "I want something warm and comforting tonight or Make a meal plan for my marathon prep",
                    },
                    {
                      num: 2,
                      title: "Get Personalized Plans",
                      desc: "Savr creates meal plans based on your preferences, ingredients, and nutritional needs",
                    },
                    {
                      num: 3,
                      title: "Cook With Guidance",
                      desc: "Follow simple instructions tailored to your cooking skill level with nutritional insights",
                    },
                    {
                      num: 4,
                      title: "Track Your Impact",
                      desc: "See your sustainability progress and health improvements over time",
                    },
                  ].map((step, index) => (
                    <div
                      key={index}
                    ...
                    >
                      <div className="bg-amber-100 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center mr-2 sm:mr-3 md:mr-5 shadow-md transform transition-transform duration-500 hover:scale-110 flex-shrink-0">
                        <span className="text-sm sm:text-base md:text-xl font-bold text-amber-800">
                          {step.num}
                        </span>
                      </div>
                      <div>
                        <h3 className="text-sm sm:text-base md:text-lg font-medium text-stone-900 mb-1">
                          {step.title}
                        </h3>
          ...
          <div className="container mx-auto px-3 sm:px-4 pt-8 sm:pt-12 md:pt-16 lg:pt-24">
            <div className="flex flex-col lg:flex-row justify-center max-w-6xl mx-auto gap-4 sm:gap-6 md:gap-8">
              ...
              <div className="flex-1 rounded-xl sm:rounded-2xl px-4 sm:px-6 md:px-8 lg:px-10 py-6 sm:py-8 md:py-10 lg:py-12 bg-white shadow-xl animate-on-scroll from-left">
                <h2 className="text-xl sm:text-2xl md:text-3xl mb-4 sm:mb-6 md:mb-8 text-amber-800 font-serif">
                  What Our Users Say
                </h2>
                  ...
                  {[
                    {
                      ...
                      role: "Food creator",
                      avatar:
                        "https://api.dicebear.com/7.x/avataaars/svg/seed=ok1",
                      quote:
                    ...
                    },
                    {
                      ...
                      avatar:
                        "https://api.dicebear.com/7.x/avataaars/svg/seed=ok",
                      quote:
                    ...
                    <div
                      key={index}
                      className="border-l-4 border-amber-300 pl-3 sm:pl-4 md:pl-6 py-1 animate-on-scroll"
                      data-delay={String(index * 300)}
                    >
                      <div className="flex items-center mb-2 sm:mb-3 md:mb-4">
                        <img
                          src={testimonial.avatar}
                          alt="User"
                          className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 rounded-full border-2 border-amber-100 shadow-md transform transition-transform duration-500 hover:scale-110"
                        />
                        <div className="ml-2 sm:ml-3 md:ml-4">
                          <h4 className="text-sm sm:text-base md:text-lg font-medium text-stone-900">
                            {testimonial.name}
                          </h4>
                          <p className="text-xs sm:text-sm md:text-base text-stone-500">
                            {testimonial.role}
                          </p>
                        </div>
                      </div>
              ...
              <div className="flex-1 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 lg:p-12 bg-stone-800 bg-opacity-95 shadow-xl animate-on-scroll from-right">
                <h2 className="text-xl sm:text-2xl md:text-3xl mb-3 sm:mb-4 md:mb-6 text-amber-300 font-serif">
                  Get in Touch
                </h2>
                <form className="text-sm sm:text-base md:text-lg">
                  <div className="mb-3 sm:mb-4 md:mb-6">
                    <label
                      className="block text-amber-100 text-xs sm:text-sm mb-2"
                      htmlFor="name"
                    >
                      Name
                    </label>
